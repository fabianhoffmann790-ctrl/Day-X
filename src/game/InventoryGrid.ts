...
const explicitSizes: Record<string, GridSize> = {
  canned_food: { cols: 1, rows: 1 }, beans: { cols: 1, rows: 1 }, crackers: { cols: 1, rows: 1 }, energy_bar: { cols: 1, rows: 1 }, apple: { cols: 1, rows: 1 }, rotten_food: { cols: 1, rows: 1 },
  water_bottle: { cols: 1, rows: 2 }, canteen: { cols: 1, rows: 2 }, dirty_water: { cols: 1, rows: 2 }, clean_water: { cols: 1, rows: 2 }, soda: { cols: 1, rows: 1 }, sports_drink: { cols: 1, rows: 2 },
  bandage: { cols: 1, rows: 1 }, rag: { cols: 1, rows: 1 }, improvised_bandage: { cols: 1, rows: 1 }, disinfectant: { cols: 1, rows: 2 }, painkillers: { cols: 1, rows: 1 }, antibiotics: { cols: 1, rows: 1 }, blood_bag: { cols: 1, rows: 2 }, saline: { cols: 1, rows: 2 },
  kitchen_knife: { cols: 1, rows: 2 }, crowbar: { cols: 1, rows: 3 }, hatchet: { cols: 2, rows: 3 }, wooden_spear: { cols: 1, rows: 4 }, pistol: { cols: 2, rows: 2 }, rifle: { cols: 6, rows: 2 },
  ammo_9mm: { cols: 1, rows: 1 }, ammo_556: { cols: 1, rows: 1 },
  tshirt: { cols: 2, rows: 1 }, hoodie: { cols: 2, rows: 2 }, work_jacket: { cols: 2, rows: 2 }, rain_jacket: { cols: 2, rows: 2 }, work_pants: { cols: 2, rows: 2 }, military_pants: { cols: 2, rows: 2 }, boots: { cols: 2, rows: 2 }, gloves: { cols: 1, rows: 1 }, motorcycle_helmet: { cols: 2, rows: 2 }, military_helmet: { cols: 2, rows: 2 }, tactical_vest: { cols: 3, rows: 3 }, plate_carrier: { cols: 3, rows: 3 },
  small_backpack: { cols: 3, rows: 3 }, hiking_backpack: { cols: 3, rows: 4 }, field_pack: { cols: 4, rows: 4 }, improvised_backpack: { cols: 3, rows: 3 },
